...
for it in tqdm(range(itmax)):
    ...
    if H.comm.Get_rank() == 0:
        ...
        if it%1 == 0:
            print("(FedNL) [Iteration. {}] Lost funciton at this iteration {}  and gradient norm {}, loss err {}".format(it,LossSerial(x),np.linalg.norm(Grad),np.abs(LossStar-LossSerial(x))));
